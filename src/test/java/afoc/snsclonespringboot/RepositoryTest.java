...
public class RepositoryTest {
    ...
    public void testMemberRepository(){
        ...
        Member member1 = new Member("a", "a", "a", "a", "a");
        Member member2 = new Member("b", "b", "b", "b", "b");
        ...
        Like like1 = new Like(board1.getId(), member1.getId());
        Like like2 = new Like(board1.getId(), member2.getId());

        jlr.save(like1);
        jlr.save(like2);

        List<Long> findLikeList = jlr.findLikeListByBoardId(board1.getId());
        ...
        jlr.deleteLike(board1.getId(), member1.getId());
